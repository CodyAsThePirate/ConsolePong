========================================================================
    KONSOLENANWENDUNG: ConsolePong-Projektübersicht
========================================================================

Diese ConsolePong-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre ConsolePong-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ConsolePong.pch und eine 
